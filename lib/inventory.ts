...
export async function markTransactionPaid(transaction_id: ID) {
  ...
  await db.transaction(
    "rw",
    [db.transactions, db.transaction_items, db.product_materials, db.raw_materials, db.products],
    async () => {
...
export async function seedIfEmpty() {
  ...
  await db.transaction("rw", [db.products, db.raw_materials, db.product_materials], async () => {
    // Raw materials - Kitchen ingredients (Bahan Baku Dapur)
    const beras = await db.raw_materials.add({
      name: "Beras",
      unit: "Kg",
      stock_quantity: 50,
      created_at: nowISO(),
    ...
    const ayam_potong = await db.raw_materials.add({
      name: "Ayam Potong",
      unit: "Ekor",
      stock_quantity: 10,
      created_at: nowISO(),
    ...
    const ikan_lele = await db.raw_materials.add({
      name: "Ikan Lele",
      unit: "Ekor",
      stock_quantity: 12,
      created_at: nowISO(),
    ...
    const ikan_nila = await db.raw_materials.add({
      name: "Ikan Nila",
      unit: "Ekor",
      stock_quantity: 12,
      created_at: nowISO(),
    ...
    const daging_sapi = await db.raw_materials.add({
      name: "Daging Sapi",
      unit: "Kg",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const pete = await db.raw_materials.add({
      name: "Pete",
      unit: "Pcs",
      stock_quantity: 10,
      created_at: nowISO(),
    ...
    const ikan_asin = await db.raw_materials.add({
      name: "Ikan Asin",
      unit: "Kg",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const jengkol = await db.raw_materials.add({
      name: "Jengkol",
      unit: "Kg",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const telur = await db.raw_materials.add({
      name: "Telur",
      unit: "Kg",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const kangkung = await db.raw_materials.add({
      name: "Kangkung",
      unit: "Ikat",
      stock_quantity: 10,
      created_at: nowISO(),
    ...
    const tauge = await db.raw_materials.add({
      name: "Tauge",
      unit: "Kg",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const terong = await db.raw_materials.add({
      name: "Terong",
      unit: "Kg",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const ati_ampela = await db.raw_materials.add({
      name: "Ati Ampela",
      unit: "Kg",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const kulit_ayam = await db.raw_materials.add({
      name: "Kulit Ayam",
      unit: "Kg",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const ikan_tongkol = await db.raw_materials.add({
      name: "Ikan Tongkol",
      unit: "Kg",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const kepala_ayam = await db.raw_materials.add({
      name: "Kepala Ayam",
      unit: "Kg",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const cumi_asin = await db.raw_materials.add({
      name: "Cumi Asin",
      unit: "Kg",
      stock_quantity: 2,
      created_at: nowISO(),
    ...
    const tahu = await db.raw_materials.add({
      name: "Tahu",
      unit: "Bks",
      stock_quantity: 10,
      created_at: nowISO(),
    ...
    const tempe = await db.raw_materials.add({
      name: "Tempe",
      unit: "Potong",
      stock_quantity: 20,
      created_at: nowISO(),
    ...
    const timun = await db.raw_materials.add({
      name: "Timun",
      unit: "Kg",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const daun_kol = await db.raw_materials.add({
      name: "Daun Kol",
      unit: "Pcs",
      stock_quantity: 10,
      created_at: nowISO(),
    ...
    const daun_kemangi = await db.raw_materials.add({
      name: "Daun Kemangi",
      unit: "Bks",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const cabe_merah_kecil = await db.raw_materials.add({
      name: "Cabe Merah Kecil",
      unit: "Kg",
      stock_quantity: 3,
      created_at: nowISO(),
      updated_at: nowISO(),
    })
    const cabe_merah_keriting = await db.raw_materials.add({
    ...
    const cabe_rawit_kecil = await db.raw_materials.add({
      name: "Cabe Rawit Kecil",
      unit: "Kg",
      stock_quantity: 2,
      created_at: nowISO(),
      updated_at: nowISO(),
    })
    const cabe_hijau = await db.raw_materials.add({
      name: "Cabe Hijau",
      unit: "Kg",
      stock_quantity: 2,
      created_at: nowISO(),
    ...
    const tomat = await db.raw_materials.add({
      name: "Tomat",
      unit: "Kg",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const bumbu_jadi_ayam_bakar = await db.raw_materials.add({
      name: "Bumbu jadi ayam bakar",
      unit: "Bks",
      stock_quantity: 10,
      created_at: nowISO(),
      updated_at: nowISO(),
    })
    const tomat_rampai = await db.raw_materials.add({
      name: "Tomat Rampai",
      unit: "Kg",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const bawang_merah = await db.raw_materials.add({
      name: "Bawang Merah",
      unit: "Kg",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const bawang_putih = await db.raw_materials.add({
      name: "Bawang Putih",
      unit: "Kg",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const daun_salam = await db.raw_materials.add({
      name: "Daun Salam",
      unit: "Bks",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const sereh = await db.raw_materials.add({
      name: "Sereh",
      unit: "Bks",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const daun_jeruk = await db.raw_materials.add({
      name: "Daun Jeruk",
      unit: "Bks",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const bumbu_kaldu = await db.raw_materials.add({
      name: "Bumbu Kaldu",
      unit: "Bks",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const bumbu_msg = await db.raw_materials.add({
      name: "Bumbu MSG",
      unit: "Bks",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const bumbu_kaldu_jamur = await db.raw_materials.add({
    ...
    const bumbu_saus_tiram = await db.raw_materials.add({
      name: "Bumbu Saus Tiram",
      unit: "Botol",
      stock_quantity: 3,
      created_at: nowISO(),
      updated_at: nowISO(),
    })
    const bumbu_kecap_asin = await db.raw_materials.add({
      name: "Bumbu Kecap Asin asin",
      unit: "Botol",
      stock_quantity: 3,
      created_at: nowISO(),
      updated_at: nowISO(),
    })
    const bumbu_minyak_inggris = await db.raw_materials.add({
      name: "Bumbu Minyak inggris",
      unit: "Botol",
      stock_quantity: 2,
      created_at: nowISO(),
      updated_at: nowISO(),
    })
    const kecap_manis = await db.raw_materials.add({
      name: "Kecap Manis",
      unit: "Botol",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const minyak_goreng = await db.raw_materials.add({
      name: "Minyak Goreng",
      unit: "Kg",
      stock_quantity: 10,
      created_at: nowISO(),
    ...
    const garam = await db.raw_materials.add({
      name: "Garam",
      unit: "Bks",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const gula_pasir = await db.raw_materials.add({
      name: "Gula Pasir",
      unit: "Kg",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const daun_pisang = await db.raw_materials.add({
      name: "Daun Pisang",
      unit: "Bks",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const kotak_kemasan = await db.raw_materials.add({
      name: "Kotak kemasan",
      unit: "Pcs",
      stock_quantity: 100,
      created_at: nowISO(),
    ...
    const plastik_sambal = await db.raw_materials.add({
      name: "Plastik sambal",
      unit: "Bks",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const plastik_bungkus_pesanan = await db.raw_materials.add({
      name: "Plastik Bungkus Pesanan",
      unit: "Bks",
      stock_quantity: 5,
      created_at: nowISO(),
      updated_at: nowISO(),
    })
    const plastik_es = await db.raw_materials.add({
      name: "Plastik ES",
      unit: "Bks",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const karet_gelang = await db.raw_materials.add({
      name: "Karet gelang",
      unit: "Bks",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const gas_elpiji = await db.raw_materials.add({
      name: "Gas Elpiji",
      unit: "Tabung",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const air_galon = await db.raw_materials.add({
      name: "Air Galon",
      unit: "Galon",
      stock_quantity: 10,
      created_at: nowISO(),
    ...
    const kelapa = await db.raw_materials.add({
      name: "Kelapa",
      unit: "Buah",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const sunlight = await db.raw_materials.add({
      name: "Sunlight",
      unit: "Bks",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const wipol_lantai = await db.raw_materials.add({
      name: "Wipol lantai",
      unit: "Bks",
      stock_quantity: 2,
      created_at: nowISO(),
    ...
    const tusuk_gigi = await db.raw_materials.add({
      name: "Tusuk Gigi",
      unit: "Bks",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    const tisue_kering = await db.raw_materials.add({
      name: "Tisue Kering",
      unit: "Bks",
      stock_quantity: 3,
      created_at: nowISO(),
    ...
    // Beverages (Bahan Baku Minuman)
    const kopi_hitam_gula = await db.raw_materials.add({
    ...
    const kopi_hitam_tanpa_gula = await db.raw_materials.add({
    ...
    const kopi_susu = await db.raw_materials.add({
      name: "Kopi Susu",
      unit: "Renceng",
      stock_quantity: 20,
      created_at: nowISO(),
    ...
    const kopi_kapucino = await db.raw_materials.add({
      name: "Kopi kapucino",
      unit: "Renceng",
      stock_quantity: 15,
      created_at: nowISO(),
    ...
    const goodday = await db.raw_materials.add({
      name: "Good day",
      unit: "Renceng",
      stock_quantity: 15,
      created_at: nowISO(),
    ...
    const teh_tarik = await db.raw_materials.add({
      name: "Teh Tarik",
      unit: "Renceng",
      stock_quantity: 15,
      created_at: nowISO(),
    ...
    const nutrisari = await db.raw_materials.add({
      name: "Nutrisari",
      unit: "Renceng",
      stock_quantity: 15,
      created_at: nowISO(),
    ...
    const marimas = await db.raw_materials.add({
      name: "Marimas",
      unit: "Renceng",
      stock_quantity: 15,
      created_at: nowISO(),
    ...
    const tehjus = await db.raw_materials.add({
      name: "Tehjus",
      unit: "Renceng",
      stock_quantity: 15,
      created_at: nowISO(),
    ...
    const jeruk_peras = await db.raw_materials.add({
      name: "Jeruk Peras",
      unit: "Kg",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const teh = await db.raw_materials.add({
      name: "Teh",
      unit: "Dus",
      stock_quantity: 5,
      created_at: nowISO(),
    ...
    const air_mineral = await db.raw_materials.add({
      name: "Air Mineral",
      unit: "Btl",
      stock_quantity: 50,
      created_at: nowISO(),
    ...
    const frestie = await db.raw_materials.add({
      name: "Frestie",
      unit: "Btl",
      stock_quantity: 30,
      created_at: nowISO(),
    ...
    const sprite = await db.raw_materials.add({
      name: "Sprite",
      unit: "Btl",
      stock_quantity: 30,
      created_at: nowISO(),
    ...
    const fanta = await db.raw_materials.add({
      name: "Fanta",
      unit: "Btl",
      stock_quantity: 30,
      created_at: nowISO(),
    ...
    const coca_cola = await db.raw_materials.add({
      name: "Coca cola",
      unit: "Btl",
      stock_quantity: 30,
      created_at: nowISO(),
    ...
    const pulfy_orange = await db.raw_materials.add({
      name: "Pulfy Orange",
      unit: "Btl",
      stock_quantity: 25,
      created_at: nowISO(),
    ...
    const sambal_goreng = await db.products.add({
      name: "Sambal Goreng",
      price: 18000,
      is_active: true,
      image_url: "",
    ...
    const ikan_lele_goreng = await db.products.add({
    ...
    const kopi_panas = await db.products.add({
      name: "Kopi Panas",
      price: 4000,
      is_active: true,
      image_url: "",
    ...
    const air_minum = await db.products.add({
      name: "Air Minum",
      price: 4000,
      is_active: true,
      image_url: "",
    ...
    const teh_hangat = await db.products.add({
      name: "Teh Hangat",
      price: 5000,
      is_active: true,
      image_url: "",
    ...
    await db.product_materials.bulkAdd([
      // Sambal Goreng
      { product_id: sambal_goreng, material_id: cabe_merah_kecil, quantity_needed: 0.2 },
      { product_id: sambal_goreng, material_id: cabe_rawit_kecil, quantity_needed: 0.1 },
      { product_id: sambal_goreng, material_id: bawang_merah, quantity_needed: 0.1 },
      { product_id: sambal_goreng, material_id: bawang_putih, quantity_needed: 0.05 },
      { product_id: sambal_goreng, material_id: minyak_goreng, quantity_needed: 0.05 },
      { product_id: sambal_goreng, material_id: garam, quantity_needed: 0.01 },
      
      // Ikan Lele Goreng
      { product_id: ikan_lele_goreng, material_id: ikan_lele, quantity_needed: 1 },
      { product_id: ikan_lele_goreng, material_id: minyak_goreng, quantity_needed: 0.2 },
      { product_id: ikan_lele_goreng, material_id: garam, quantity_needed: 0.01 },
      { product_id: ikan_lele_goreng, material_id: bumbu_jadi_ayam_bakar, quantity_needed: 0.05 },
      
      // Ayam Goreng
      { product_id: ayam_goreng, material_id: ayam_potong, quantity_needed: 1 },
      { product_id: ayam_goreng, material_id: minyak_goreng, quantity_needed: 0.3 },
      { product_id: ayam_goreng, material_id: garam, quantity_needed: 0.01 },
      { product_id: ayam_goreng, material_id: bumbu_jadi_ayam_bakar, quantity_needed: 0.1 },
      
      // Kopi Panas
      { product_id: kopi_panas, material_id: kopi_hitam_gula, quantity_needed: 1 },
      
      // Air Minum
      { product_id: air_minum, material_id: air_mineral, quantity_needed: 1 },
      
      // Teh Hangat
      { product_id: teh_hangat, material_id: teh, quantity_needed: 0.1 },
      { product_id: teh_hangat, material_id: gula_pasir, quantity_needed: 0.02 },
    ])
